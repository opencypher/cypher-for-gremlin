    ...
    <div class="container">
        ...
        <#else>
            <div class="alert alert-info">
                <p>Nothing changed.</p>
                <p>
                    Please make sure to run <code>./gradlew --continue tck tckSaveReport</code> on the old version
                    before running <code>./gradlew --continue tck tckRegression</code> on the updated version.
                </p>
            </div>
        </#if>
        ...
        <#if diff.newlyFailedScenarios?size != 0>
            <h2>
                Newly failed scenarios:
                <span class="label label-danger">${diff.newlyFailedScenarios?size}</span>
            </h2>
        ...
        <#if diff.newlyPassingScenarios?size != 0>
            <h2>
                ...
                <span class="label label-success">${diff.newlyPassingScenarios?size}</span>
            </h2>
