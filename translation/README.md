...
```
dependencies {
  compile 'org.opencypher.gremlin:translation:0.9.8'
}
```
...
Consult the [Javadoc](https://opencypher.github.io/cypher-for-gremlin/api/0.9.8/java/org/opencypher/gremlin/translation/package-summary.html) for more information.
