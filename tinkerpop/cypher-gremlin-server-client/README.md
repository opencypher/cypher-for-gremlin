...
```
dependencies {
  compile 'org.opencypher.gremlin:cypher-gremlin-server-client:1.0.0'
}
```
...
Consult the [Javadoc](https://opencypher.github.io/cypher-for-gremlin/api/1.0.0/java/org/opencypher/gremlin/client/package-summary.html) for more information.
