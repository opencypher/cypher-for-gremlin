...
```
dependencies {
  compile 'org.opencypher.gremlin:cypher-gremlin-server-client:0.9.4'
}
```
...
Consult the [Javadoc](https://opencypher.github.io/cypher-for-gremlin/api/0.9.4/org/opencypher/gremlin/client/CypherGremlinClient.html) for more information.
