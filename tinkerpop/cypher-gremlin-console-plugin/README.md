...
1. Install Gremlin Console Cypher plugin:
    ```
    gremlin> :install org.opencypher.gremlin cypher-gremlin-console-plugin 0.9.3
    ==>Loaded: [org.opencypher.gremlin, cypher-gremlin-console-plugin, 0.9.3] - restart the console to use [opencypher.gremlin]
    ```
