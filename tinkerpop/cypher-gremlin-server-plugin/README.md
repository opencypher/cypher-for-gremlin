...
```sh
bin/gremlin-server.sh install org.opencypher.gremlin cypher-gremlin-server-plugin 0.9.3
Installing dependency org.opencypher.gremlin cypher-gremlin-server-plugin 0.9.3
...
```
